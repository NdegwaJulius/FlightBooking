...
class Reset_Password_Verification extends StatefulWidget {
  final String phoneNumber;

  Reset_Password_Verification(this.phoneNumber);

  @override
  _Reset_Password_VerificationState createState() =>
      _Reset_Password_VerificationState();
}

class _Reset_Password_VerificationState
    extends State<Reset_Password_Verification> {
  var onTapRecognizer;
